                            ...
                            HStack {
                                ...
                                Button(action: {
                                    ...
                                    Image(systemName: note.realized ? "checkmark.circle.fill" : "circle")
                                        .font(.title2)
                                        .foregroundColor(note.realized ? Color(#colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1)) : .primary)
                                }
    ...
    var body: some View {
        ScrollView {
            VStack {
                ...
                HStack {
                    Text("Sing Loop is developed by Three Dollar.")
                        .font(.title3.bold())
                    Spacer()
                }
